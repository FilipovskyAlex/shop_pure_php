...
class Pagination
{
     ...
     * @param int type $total <p>Общее количество записей</p>
     * @param int type $currentPage <p>Номер текущей страницы</p>
     * @param int type $limit <p>Количество записей на страницу</p>
     * @param string type $index <p>Ключ для url</p>
     */
    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            ...
            if ($page == $this->current_page) {
                $links .= '<li class="pagination-link active"><a href="#">' . $page . '</a></li>';
            } else {
