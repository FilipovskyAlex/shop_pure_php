            ...
            <div class="admin-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Удаление категории</li>
                    </ol>
                </nav>
            </div>
            <p style="padding: 10px 0 20px 20px; font-size: 24px; margin-bottom: 0;">Удаление категории № <?= $id?></p>
            <p style="padding: 10px 0 20px 20px; font-size: 20px; margin-bottom: 0;">Вы действительно хотите удалить эту категорию из базы данных?</p>
            <form method="post">
