            ...
            <div class="admin-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Удаление товара</li>
                    </ol>
                </nav>
            </div>
            <p style="padding: 10px 0 20px 20px; font-size: 24px; margin-bottom: 0;">Удаление товара № <?= $id?></p>
            <p style="padding: 10px 0 20px 20px; font-size: 20px; margin-bottom: 0;">Вы действительно хотите удалить это товар из базы данных?</p>
            <form method="post">
